...
<body>
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<button id="uploadPrcDefBtn" type="button" class="btn btn-primary"
							style="float: right;">
						...
						<div class="table-responsive">
							...
							<form id="deployForm" action="" method="post"
	...
	<script type="text/javascript">
		...
		$("#processDefFile").change(function() {
			var options = {
				url : "${APP_PATH}/process/doDeploy.do",
				beforeSubmit : function() {
					loadingIndex = layer.msg('数据正在部署中', {
						icon : 6
					});
					return true;
				},
										...
										.each(
												...
												function(i, n) {
													...
													content += '  <td>' + n.key
															+ '</td>';
													content += '  <td>';
													content += '      <button type="button" onclick="window.location.href=\'${APP_PATH}/process/showing.do?id='
															+ n.id
															+ '\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-eye-open"></i></button>';
													content += '      <button type="button" onclick="deleteProDef(\''
															+ n.id
															+ '\',\''
															+ n.name
		...
		function deleteProDef(id, name) {
			layer.confirm("确认要删除这个[" + name + "]用户吗?", {
				...
				$.ajax({
					...
					url : "${APP_PATH}/process/doDeleteProDef.do",
					beforeSend : function() {
