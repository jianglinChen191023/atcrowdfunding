			  ...
			  <div class="panel-body">
				<form id="addForm" role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" maxlength="20" id="fname" placeholder="请输入名称"  onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" autocomplete="off">
