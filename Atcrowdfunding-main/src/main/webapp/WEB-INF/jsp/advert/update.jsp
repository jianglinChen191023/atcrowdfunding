				...
				<form id="updateForm" role="form">
				  ...
				  <div class="form-group">
					<label for="exampleInputPassword1">广告描述</label>
				  	<input type="text" class="form-control" maxlength="20" id="fname" placeholder="请输入广告描述" value="${advert.name }" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" style="ime-mode:disabled" autocomplete="off">
				  ...
				  <div class="form-group">
					<label for="exampleInputPassword1">状态</label><br/>
				  	<select id="fstatus" name="fstatus" class="form-control">
 						 ...
 						 <c:if test="${advert.status==3 }">
 						    <option value ="0">草稿</option>
				  		 	<option value ="1">未审核</option>
  						 	<option value ="2">已审核</option>
 						 	<option value="3" selected="selected">已发布</option>
				  		 </c:if>
				  		 <c:if test="${advert.status==null }">
				  		    <option value ="0">草稿</option>
				  		 	<option value ="1" selected="selected">未审核</option>
  						 	<option value ="2">已审核</option>
 						 	<option value="3" >已发布</option>
