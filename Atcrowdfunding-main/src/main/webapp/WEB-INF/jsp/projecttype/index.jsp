 ...
 <hr style="clear:both;">
	...
	<script type="text/javascript" src="${APP_PATH }/jquery/layer/layer.js"></script>	
        ...
        <script type="text/javascript">
            ...
            //分页查询 
            var loadingIndex = -1;
            function queryPageProjectType(pageno){
            	jsonObj.pageno = pageno;
            	$.ajax({
            		type : "POST",
            		data : jsonObj,
            		url : "${APP_PATH}/projectType/doIndex.do",
            		beforeSend : function(){
            		...
            		success : function(result){
            			...
            			if(result.success){
            				...
            				$.each(data, function(i,n){
                				...
                				content+='      <button type="button" onclick="window.location.href=\'${APP_PATH}/projectType/toUpdate.htm?id='+(n.id)+'\'" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
                				content+='	    <button type="button" onclick="deleteProjectType('+n.id+',\''+n.name+'\')" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
                				content+='  </td>';
                				content+='</tr>';
            				});
            				...
            				if(page.pageno == 1){
            					...
            					contentBar+='	<li><a href="#" onclick="queryPageProjectType('+(page.pageno-1)+')">上一页</a></li>';
            				}
            				...
            				for (var i = 0; i < page.totalno; i++) {
            					...
            					contentBar+='	><a href="#" onclick="queryPageProjectType('+(i+1)+')">'+(i+1)+' <span';
            				...
            				if(page.pageno == page.totalno){
            					...
            					contentBar+='	<li><a href="#" onclick="queryPageProjectType('+(page.pageno+1)+')">下一页</a></li>';
            				}
            ...
            function deleteprojectType(id,name){
            	...
            	layer.confirm("确认要删除这个["+name+"]用户吗?",  {icon: 3, title:'提示'}, function(cindex){
            		$.ajax({
    	            	...
    	            	url : "${APP_PATH}/projectType/doDelete.do",
    	            	beforeSend : function(){
            ...
            $("#deleteBatchBtn").click(function(){
				...
				$.each(selectCheckbox,function(i,n){
					jsonObject["datasprojectType["+i+"].id"] = n.id;		
				...
				layer.confirm("确认要删除这些用户吗?",  {icon: 3, title:'提示'}, function(cindex){
					...
					$.ajax({
    	            	type : "POST",
						data : jsonObject,
    	            	url : "${APP_PATH}/projectType/doDeleteBatch.do",
    	            	beforeSend : function(){
