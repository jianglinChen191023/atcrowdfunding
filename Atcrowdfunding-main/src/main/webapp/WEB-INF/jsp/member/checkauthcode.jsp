...
<body>
		...
		<form role="form" style="margin-top: 20px;">
			<div class="form-group">
				<label for="authcode">验证码</label> <input type="text"
					class="form-control" id="authcode" placeholder="请输入你邮箱中接收到的验证码" autocomplete="off" >
			</div>
	...
	<script>
		...
		$("#finishBtn").click(
				function() {
					finish("${APP_PATH}/member/finishApply.do",
							"${APP_PATH}/member.htm");
				});

		function finish(controllerRequestMapping, href) {
			$.ajax({
				type : "POST",
