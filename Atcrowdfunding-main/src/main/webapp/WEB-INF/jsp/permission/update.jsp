			  ...
			  <div class="panel-body">
				<form id="addForm" role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" maxlength="20" id="fname" placeholder="请输入许可名称" value="${permission.name }" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" autocomplete="off">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" maxlength="20" id="furl" placeholder="请输入URL" value="${permission.url }" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" style="ime-mode:disabled" autocomplete="off">
